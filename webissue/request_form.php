...
<!--		<label for="email" class="">@email.arizona.edu</label>	-->
	    ...
	    <div class="form-group">
	    	...
	    	<textarea class="supportRequest-textarea" name="supportRequestText" id="supportRequest" rows="12" wrap="hard" value="" required><?php wi_oldInputs($wi_oldInputs,'text'); ?></textarea>
	    </div>
	    <hr class="form-hr">
