...
<div class="main-content" style="margin-right:10px;">
   ...
   <?php
		...
		if ($_POST['emailConfirm'] == 'sent') {
			?>
			<p class="bg-success email-confirmation">Email has been sent successfully!</p>

			<a href="/index.php" class="btn btn-primary btn-lg btn-block email-conf-btn">Back to Home</a>
			<a href="/webissue/index.php" class="btn btn-primary btn-lg btn-block email-conf-btn">Request another issue</a>
			<?php
		}else {
			?>
			<script type="text/javascript">
				
			window.location.replace("<?php echo 'http://'.$_SERVER[HTTP_HOST].'/'; ?>");
