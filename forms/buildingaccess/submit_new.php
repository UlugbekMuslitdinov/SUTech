<?php
	...
	$fields = array("supervisor_name"=>80, "supervisor_phone"=>20, "access"=>0,
		"other_areas"=>120, "alarm_access"=>1, "alarm_password"=>20, "alarm_area"=>80,
...
$addtl_fields = array("employee_first_name"=>45, "employee_last_name"=>45, "catcard"=>20, "pin"=>10, "employee_unit"=>60, "employee_id"=>45, "net_id"=>45);
	...
	if ($_POST["access"] > 0) {
		...
		if (isset($_POST["alarm_password"])&&$_POST["alarm_password"]!="") {
			$message .= 'Alarm Password: <b>'.$_POST["alarm_password"].'</b><br />';
		}
