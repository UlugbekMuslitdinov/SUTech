			...
			<div style="margin-bottom:20px;">
				...
				<div style="margin:0px;">
					...
					<div class="fieldset_right">
						...
						<input name="alarm_access" value="Yes" type="radio" <?php if ($_SESSION["formdata"]["alarm_access"] == "Y") {echo "checked";} ?> /> Yes<br />
						<input name="alarm_access" value="No" type="radio" <?php if ($_SESSION["formdata"]["alarm_access"] == "N") {echo "checked";} ?> /> No<br /><br />
						<b>Alarm Access Password:</b>
							<span style="font-weight: normal;"><i>(if applicable)</i></span>
						...
						<input name="alarm_area" id="alarm_area" type="text" maxlength="80" class="field_text <?php if ($_SESSION["errors"]["alarm_area"]) {echo "required_error";} ?>" value="<?php if (isset($_SESSION["formdata"]["alarm_area"])) {echo $_SESSION["formdata"]["alarm_area"];} ?>" />
					</div>
				</div>
				<div style="clear:both;"></div>
			</div>
