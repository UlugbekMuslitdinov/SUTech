...
//	require_once("sidebar.php");
	...
	$required_fields = array("supervisor_name", "supervisor_phone", "form_type");
	$fields = array("supervisor_name"=>80, "supervisor_phone"=>20,
		"other_areas"=>120, "alarm_access"=>1, "alarm_area"=>80,
	"form_type"=>45, "net_id"=>45);
	$addtl_required_fields = array("employee_first_name", "employee_last_name", "catcard", "employee_unit", "employee_id", "employee_phone", "employee_job");
	$addtl_fields = array("employee_first_name"=>45, "employee_last_name"=>45, "catcard"=>20, "employee_unit"=>60, "employee_id"=>45, "net_id"=>45, "employee_phone"=>15, "employee_job"=>60);
	...
	if($_POST['form_type'] == "Key Request"){
		$subject = "Key Request - $count_employees Employees";
	}else{
		$subject = "Locker Request - $count_employees Employees";
	}
	...
	foreach($_SESSION["formdata"]["employee_multi"] as $num=>$emp){
		...
		Employee Phone #: <b>'.$emp['employee_phone'].'</b><br />
		Employee Job: <b>'.$emp['employee_job'].'</b><br />';
	...
	if($_POST['form_type'] == "Key Request") {
		$message .= '<br />Building #: <b>' . $_POST['building_number'] . '</b>';
		$message .= '<br />Room #: <b>' . $_POST['room_number'] . '</b>';
		$message .= '<br />Notes: <b>' . $_POST['notes'] . '</b>';
	}
...
?>
<h1>Key & Locker Request Form</h1><br />
<?php
if ($email) {
