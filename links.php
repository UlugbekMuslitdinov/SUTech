...
li.definition {
	...
	list-style-image: url('/images/links.png') !important;
}
</style>

<h1>Helpful Links</h1>
<ul>
	<li>Use the Student Unions PCF file with the UA VPN to access Kronos</li>
	...
	<li>SU Micros netvupoint & Sequioa</li>
		<li class="definition"><a href="http://150.135.73.46/login.jsp">SU Micros netvupoint login page</a> <span style="color: #B00;">(You must use IE8 in compatibility mode)</span></li>
		<li class="definition"><a href="https://qpc.transactcampus.com/?tenant=arizona">Quadpoint Web Client</a></li>
		<li class="definition"><a href="forms/computeraccess/">Request access to SU Micros netvupoint</a></li>
		<li class="definition"><a href="http://150.135.72.231/MX4/_private/RequestWork1.asp?ID=14">Report a problem accessing SU Micros netvupoint</a></li>
	<li>Common Student Unions Website Links</li>
		<li class="definition"><a href="https://union.arizona.edu/">Arizona Student Unions Homepage</a></li>
		<li class="definition"><a href="https://union.arizona.edu/mealplans/">Arizona Student Unions Meal Plans</a></li>
		<li class="definition"><a href="http://intra.union.arizona.edu/">Arizona Student Unions Intra</a></li>
    ...
    <li>Campus Software and Licensing</li>
        <li class="definition"><a href="https://sitelicense.arizona.edu/">Site Licensed Software (VPN Client, Sophos, Textpad, etc...)</a></li>
        <li class="definition"><a href="http://uabookstore.arizona.edu/technology/campuslicensing/default.asp">Campus Licensing Software from the Bookstore<br />(Mircosoft Windows, Mircosoft Office, Apple Software, etc..)</a></li>
